...
export default function Logo({ className, invert = false, size = '1em' }: LogoProps) {
    ...
    return (
        ...
        >
            ...
            <path d="M363.16,0v314.14h-37.13v-89.02c0-30.82-24.81-55.88-55.28-55.88H37.13v144.9H0V0h37.13v78.05c0,33.22,26.79,60.28,59.68,60.28h229.21V0h37.13Z" />
            <path d="M664.21,0v241.05c0,24.42-5.59,42.95-16.64,55-11.06,12.01-30.63,18.09-58.17,18.09h-94.28v-30.9h94.28c13.35,0,23.06-2.6,28.89-7.77,5.9-5.24,8.76-16.53,8.76-34.42V30.94h-208.41v107.39h174.48v30.9h-140.05c-18.98,0-34.44,15.61-34.44,34.78v110.12h-37.13V94.59c0-52.16,42.01-94.59,93.64-94.59h189.07Z" />
            <path d="M1077.96,283.24v30.9h-289.23c-54.49,0-98.79-44.75-98.79-99.75V0h305.34v30.94h-268.17v107.39h256.95v30.9h-256.95v114h350.86Z" />
        </svg>
    );
}
